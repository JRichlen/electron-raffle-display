...
import {maxRaffleNumbersAllowed} from './constants.json';
import {RaffleNumberInput} from './raffle-number-input.jsx';
import {RaffleNumberButton} from './raffle-number-button.jsx';
import {UnlockRaffleInputButton} from './raffle-number-input-unlock-button.jsx';
    ...
    render() {
        ...
        return (
            <div className="raffle-number-display">
                ...
                {lockRaffleInput ?
                    raffleNumbers.length < maxRaffleNumbersAllowed &&
                    <UnlockRaffleInputButton unlockRaffleInput={forceUnlockRaffleInput} /> :
